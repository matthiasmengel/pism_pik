...
PetscErrorCode IceModel::init_diagnostics() {
  ...
  ts_diagnostics["cumulative_surface_ice_flux_sheet"]   = new IceModel_cumulative_surface_flux_sheet(this, grid, variables);
  ts_diagnostics["surface_ice_flux_shelf"]   = new IceModel_surface_flux_shelf(this, grid, variables);
  ts_diagnostics["cumulative_surface_ice_flux_shelf"]   = new IceModel_cumulative_surface_flux_shelf(this, grid, variables);
...
PetscErrorCode IceModel_surface_flux_sheet::update(PetscReal a, PetscReal b) {
  PetscErrorCode ierr;
  PetscReal value;

  value = model->cumulative_surface_ice_flux_sheet;
...
IceModel_cumulative_surface_flux_sheet::IceModel_cumulative_surface_flux_sheet(IceModel *m, IceGrid &g, PISMVars &my_vars)
  : PISMTSDiag<IceModel>(m, g, my_vars) {

  // set metadata:
  ts = new DiagnosticTimeseries(&grid, "cumulative_surface_ice_flux_sheet", time_dimension_name);
...
PetscErrorCode IceModel_cumulative_surface_flux_sheet::update(PetscReal a, PetscReal b) {
  PetscErrorCode ierr;
  PetscReal value;
...
PetscErrorCode IceModel_surface_flux_shelf::update(PetscReal a, PetscReal b) {
  PetscErrorCode ierr;
  PetscReal value;

  value = model->cumulative_surface_ice_flux_shelf;
...
IceModel_cumulative_surface_flux_shelf::IceModel_cumulative_surface_flux_shelf(IceModel *m, IceGrid &g, PISMVars &my_vars)
  : PISMTSDiag<IceModel>(m, g, my_vars) {

  // set metadata:
  ts = new DiagnosticTimeseries(&grid, "cumulative_surface_ice_flux_shelf", time_dimension_name);
...
PetscErrorCode IceModel_cumulative_surface_flux_shelf::update(PetscReal a, PetscReal b) {
  PetscErrorCode ierr;
  PetscReal value;
